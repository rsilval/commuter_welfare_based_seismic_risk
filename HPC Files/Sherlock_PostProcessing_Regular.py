...
for set in range(81,101):
    ...
    for ind_run in runs:
        ...
        with open(job_file,'wb') as fh:
            ...
            fh.writelines("#SBATCH --job-name=%s.2min\n" % str(ind_run))
            ...
            fh.writelines("python Postprocessing_Outputs_Regular.py %s\n" % ind_run)
